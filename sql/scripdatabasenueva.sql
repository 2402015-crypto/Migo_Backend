...
CREATE DATABASE IF NOT EXISTS `migo_db_vue` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `migo_db_vue`;
...
-- Volcando datos para la tabla migo_db_vue.colonias
...
-- Volcando datos para la tabla migo_db_vue.dias_semana
...
-- Volcando datos para la tabla migo_db_vue.especies
...
-- Volcando datos para la tabla migo_db_vue.estados_publi
...
-- Volcando datos para la tabla migo_db_vue.servicios
...
-- Volcando datos para la tabla migo_db_vue.tipos_publi
INSERT INTO `tipos_publi` (`id_tipo`, `nombre`) VALUES
    (1, 'Se busca'),
    (2, 'Adopción');

-- ===================================================================
-- 2) Tablas de usuarios y veterinarias (deben existir antes de FKs)
-- ===================================================================
...
-- Volcando datos para la tabla migo_db_vue.usuarios
...
-- ===================================================================
-- 3) Tablas principales que referencian catálogos y usuarios
-- ===================================================================
...
-- ===================================================================
-- 4) Tablas dependientes (después de publicaciones, usuarios, etc.)
-- ===================================================================
...
-- ===================================================================
-- 5) Triggers (después de publicaciones y estados_publi)
-- ===================================================================
...
-- ===================================================================
-- 6) Funciones y procedimientos (al final, después de tablas y triggers)
-- ===================================================================
